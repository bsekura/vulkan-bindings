...
pub const OBJECT_TYPE_OBJECT_TABLE_NVX: i32 = 1000086000; // VkobjectTableNVX
pub const OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NVX: i32 = 1000086001; // VkIndirectCommandsLayoutNVX
